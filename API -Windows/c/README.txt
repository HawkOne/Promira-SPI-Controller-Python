...
Introduction
------------
This directory contains examples that use the Promira Rosetta C/C++
language bindings.
...
- Visual C++ workspace for MSVC++ 2008 and above
...
1) Open MSVC2008/Makefile.sln
2) Build | Batch Build... | Build
3) Optionally place promira.dll in the PATH
4) _output/PROGRAM
